    ...
    <div className='conatin'>
      <div className='contain-dot'>
        ...
        <div className='timeline'>
            ...
            <p className='icons hi-img'><img src={png2} alt='2 img'/></p>
              <div className='text-box'>
                <div className='tb'>
            ...
            <div className='container-time right-container'>
            <p className='icons  hi-img'><img src={png4}  alt='4 img'/></p>
              <div className='text-box'>
              <div className='tb'>
            ...
            <div className='container-time right-container'>
            <p className='icons  hi-img'><img src={png6} style={{position :'absolute' , right :'94.5%'}} alt='6 img'/></p>
              <div className='text-box'>
              <div className='tb'>
            ...
            <div className='container-time right-container'>
            <p className='icons hi-img'><img src={png8}  alt='6 img'/></p>
              <div className='text-box'>
              <div className='tb'>
